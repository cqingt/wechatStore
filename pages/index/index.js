...
var pageData = {
  data: {
    ...
    "search1":{ // 搜索
      ...
      "content":{"placeholder":"\u641c\u7d22\u60a8\u7684\u7f8e\u5473"},
      "customFeature":{
        "searchObject":{
          "type":"goods-list",
          "name":"\u5546\u54c1\u5217\u8868",
          "content":"",
          "customFeature":{"lineBackgroundColor":"rgb(255, 255, 255)","lineBackgroundImage":"","margin":0,"lineHeight":212,"imgWidth":"150","imgHeight":"150","vesselAutoheight":1,"height":"300px","form":"goods","mode":1,"name":"\u5546\u54c1\u5217\u8868","ifUseContact":true,"id":"list-37220340"},
          "style":{"background-color":"rgb(243, 243, 243)","background-image":"","margin-top":"0px","opacity":1,"color":"rgb(102, 102, 102)","font-size":"14px"},
          "id":"zhichi_4876600202"
        }
      },
    },
    "picture2":{
      "type":"picture",
      "style":"opacity:1;background-color:transparent;border-color:rgb(34, 34, 34);border-style:none;height:405.46875rpx;width:750rpx;margin-left:auto;margin-right:auto;",
      "content":"http:\/\/img.weiye.me\/zcimgdir\/album\/file_58c6400de9737.png",
      "customFeature":{"boxShadow":"5","boxColor":"#000","boxX":"0","boxY":"0","boxR":"5"},
      "animations":[],
      "page_form":"",
      "compId":"picture2",
    ...
    "goods_list3":{ // 商品列表
      ...
      "page_form":"",
      "compId":"goods_list3",
      "parentCompid":"goods_list3",
      "list_style":"background-color:rgb(255, 255, 255);height:496.875rpx;margin-left:auto;","img_style":"width:351.5625rpx;height:351.5625rpx;margin-left:auto;",
      "title_width":{"width":"375rpx"},
      "param":"{\"id\":\"list-37220340\",\"form\":\"goods\",\"goods_type\":0,\"page\":1,\"app_id\":\"RFF1h2JIfF\",\"is_count\":0,\"is_integral\":0}"
    },
    "carousel": { // 轮播图
      "type": "carousel",
      ...
      "content": [
        {
          "pic": "http://osg1aqywx.bkt.clouddn.com/image.png",
          "goods_id": "0",
    ...
    "page_hidden":true,
    "page_form":"",
    "top_nav":{"navigationBarBackgroundColor":"#000000","navigationBarTextStyle":"white","navigationBarTitleText":"\u9996\u9875"}
  },
  need_login: false,
  page_router: 'index',
  page_form: 'none',
  ...
  getBanners: function(){
    ...
    app.sendRequest({
      ...
      success: function (res) {
        if (res.code == 200) {
          let data = [];
          data['carousel.content'] = res.data;
          _this.setData(data);
        }
      }
    });
